...
def upload_file():
    ...
    algorithm = 'brute_force' if request.form['alg'] == "DP" else 'linear_programming'
    ...
    try:
        ...
        alg_type = 'BF' if request.form['alg'] == "DP" else 'LP'
        output_json_path = os.path.join('..', 'perfect_pace_data', 'results', base_filename,alg_type, f"{time}min_{paces}p.json")
        output_txt_path = os.path.join('..', 'perfect_pace_data', 'results', base_filename,alg_type, f"{time}min_{paces}p_segments.json")
        output_mile_txt_path = os.path.join('..', 'perfect_pace_data', 'results', base_filename,alg_type, f"{time}min_{paces}p_miles.json")
